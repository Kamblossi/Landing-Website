...
const Shop = () => {
  ...
  return (
    <Section ref={ref} id="shop">
      ...
      <Left>
        <p>
          Every project begins with understanding your unique narrative. Our process starts with a collaborative consultation, where we listen intently to your vision, explore your ideas, and identify the core story you wish to tell. We delve into the emotions, messages, and moments that matter most to you, ensuring our creative direction perfectly aligns with your aspirations, whether it's for a personal milestone, a significant event, or a powerful brand campaign.
          <br /> <br />
